...
[KernelFunction]
    ...
    /// </summary>
[KernelFunction]
    [Description("Get booking for specific hotel with Id.")]
    ...
    /// </summary>
[KernelFunction]
    [Description("Get booking for specific hotel with Id and date")]
    public async Task<IEnumerable<Booking>> GetBookingsByHotelAndMinimumDate(
        [Description("The ID of the hotel")] int hotelId,  [Description("The date of arrival")] DateTime dt)
    {
...
[KernelFunction]
    [Description("Get bookings with more than one room")]
